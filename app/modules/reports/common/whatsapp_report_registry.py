...
WHATSAPP_REPORT_DEFINITIONS: tuple[WhatsAppReportDefinition, ...] = (
    ...
    WhatsAppReportDefinition(
        ...
        report_key="pending-payments",
        label_key="report_flow.report_labels.pending_payments",
        requires_event_id=True,
        supported_formats=("csv", "excel"),
    ),
    WhatsAppReportDefinition(
        ...
        report_key="expense-summary",
        label_key="report_flow.report_labels.expense_summary",
        requires_event_id=True,
        supported_formats=("csv", "excel"),
    ),
    WhatsAppReportDefinition(
        ...
        report_key="participation",
        label_key="report_flow.report_labels.participation_report",
        requires_event_id=True,
