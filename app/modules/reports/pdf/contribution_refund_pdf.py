...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 25 16:56:36 2026
...
def generate_contribution_refund_pdf(
    *,
    ...
    pdf = BasePDF(
        ...
        report_title="Contribution Refunds Report",
        logo_path=logo_path
    )
    ...
    elements.append(
        pdf.summary_box(
            ...
            [[translate("report_exports.labels.summary.total_refunded", lang), format_currency(report["total_refunded"])]]
        )
    )
