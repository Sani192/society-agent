...
def handle_committee_intent(
    *,
    ...
    if intent == "APPROVE":
        ...
        parts = message.split()
        if len(parts) < 3:
            return info_response(translate("committee.approvals.approve_user_example", lang))
    ...
    if intent == "APPROVE_PAYMENT":
        ...
        parts = message.split()
        if len(parts) < 3:
            return info_response(translate("committee.approvals.approve_payment_example", lang))
    ...
    if intent == "APPROVE_REFUND":
        ...
        parts = message.split()
        if len(parts) < 3:
            return info_response(translate("committee.approvals.approve_refund_example", lang))
