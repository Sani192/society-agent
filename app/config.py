...
class Settings:
    ...
    SCHEDULER_ENABLED = _env_flag("SCHEDULER_ENABLED", "true")
    STARTUP_MIGRATIONS_ENABLED = _env_flag("STARTUP_MIGRATIONS_ENABLED", "false")
    ...
    WHATSAPP_READINESS_MODE = _env_choice("WHATSAPP_READINESS_MODE", "sanity", choices={"sanity", "connectivity"})
    WHATSAPP_CONNECTIVITY_TIMEOUT_SECONDS = _env_int("WHATSAPP_CONNECTIVITY_TIMEOUT_SECONDS", 3)
    WHATSAPP_ALERT_FAILED_SENDS_THRESHOLD = _env_int("WHATSAPP_ALERT_FAILED_SENDS_THRESHOLD", 5)
    WHATSAPP_ALERT_RETRIES_SCHEDULED_THRESHOLD = _env_int("WHATSAPP_ALERT_RETRIES_SCHEDULED_THRESHOLD", 10)
    WHATSAPP_ALERT_DLQ_GROWTH_THRESHOLD = _env_int("WHATSAPP_ALERT_DLQ_GROWTH_THRESHOLD", 5)
