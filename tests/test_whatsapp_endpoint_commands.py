...
COMMITTEE_CASES = [
    ...
    ("EXPORT_REPORT", "export reports event-summary pdf"),
    ("EXPORT_FINANCIAL_REPORT", "export financial event-summary pdf"),
    ("EXPORT_ADMIN_REPORT", "export admin onboarding-status csv"),
    ("EXPORT_GOVERNANCE_REPORT", "export governance audit excel"),
