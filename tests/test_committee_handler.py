...
def test_committee_generate_food_tokens(monkeypatch):
    ...
    announce_spy = MagicMock(return_value=SimpleNamespace(accepted_count=1, skipped_count=0, announcement_id="ann-1"))
    monkeypatch.setattr("app.handlers.shared.committee.AnnouncementManager.queue", announce_spy)
...
def test_committee_open_food_counter(monkeypatch):
    ...
    announce_spy = MagicMock(return_value=SimpleNamespace(accepted_count=1, skipped_count=0, announcement_id="ann-2"))
    monkeypatch.setattr("app.handlers.shared.committee.AnnouncementManager.queue", announce_spy)
...
def test_committee_food_dashboard(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda **kwargs: {
            ...
            "recent_served": [{"token": "AB2K9M", "flat_number": "A-101", "food_type": "veg", "served_at": None}],
        },
    )
